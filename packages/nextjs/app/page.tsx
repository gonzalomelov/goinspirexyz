      ...
      <div className="flex items-center flex-col flex-grow pt-10">
        <div className="px-5">
          <h1 className="text-center">
            ...
            <span className="block text-2xl font-bold">gosolve.xyz</span>
          </h1>
            ...
            <div className="flex flex-col bg-base-100 px-10 py-10 text-center items-center max-w-xs rounded-3xl">
              ...
              <p>
                ...
                <Link href="/simulations/create" passHref className="link">
                  Create a new onchain simulation
                </Link>{" "}
                and get it solved right away.
              </p>
            </div>
            <div className="flex flex-col bg-base-100 px-10 py-10 text-center items-center max-w-xs rounded-3xl">
              <MagnifyingGlassIcon className="h-8 w-8 fill-secondary" />
              <p>
                Manage your onchain simulations on{" "}
                <Link href="/simulations" passHref className="link">
                  My Onchain Simulations
                </Link>{" "}
                list.
              </p>
            </div>
